...
function readDependencies(packagePath) {
    return readPackageJson(packagePath).then(function (packageJson) {
        ...
        .catch(function (error) { return handle_error_1.handleError(error, "Cannot read package.json in " + packagePath); });
}
function readPackageJson(folderPath) {
    return new Promise(function (resolve) {
        fs.readFile(path.join(folderPath, 'package.json'), function (error, data) {
            if (error) {
                throw error;
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    es6EntryFileName = path_utils_1.getFileName(es6EntryPath);
...
function createPackagesFilesMap(dependencies, modulesFolderPath, cwd) {
    return __awaiter(this, void 0, void 0, function () {
        var map, _loop_1, _i, dependencies_1, key;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    map = {};
                            ...
                            switch (_c.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, locatePackageFiles(path.join(cwd, 'node_modules', key))
                                            .catch(function (error) { return handle_error_1.handleError(error, "Cannot locate " + key + " package files", { files: [] }); })];
                                case 1:
                                    _a[_b] = _c.sent();
                                    return [2 /*return*/];
                            }
                            ...
                            switch (_b.label) {
                                case 0:
                                    ...
                                    _loop_3 = function (file) {
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, copyFile(packagesFilesMap.map[key].folder, file, outDirPath, packagesFilesMap)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, readDependencies('./package.json')
