...
function collectPackageInfo(packagePath) {
    return __awaiter(this, void 0, void 0, function () {
        var packageJson, es6EntryPath, es6EntryFileName, es6FolderPath, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2: return [2 /*return*/, (_a.files = _b.sent(),
                        _a.global = false,
                        _a)];
                case 3:
...
function createSingleFilePackage(packagePath, modulePath) {
    return {
        entry: modulePath,
        folder: packagePath,
        files: [modulePath]
...
function createPackagesFilesMap(dependencies, modulesFolderPath, cwd) {
    return __awaiter(this, void 0, void 0, function () {
        var modules, globals, progress, _loop_1, _i, dependencies_1, key;
        return __generator(this, function (_a) {
            switch (_a.label) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, collectPackageInfo(path.join(cwd, 'node_modules', key))
                                            .catch(function (error) { return handle_error_1.handleError(error, "Cannot collect " + key + " package info", null); })];
                                case 1:
                                    info = _a.sent();
                                    if (info.global) {
                ...
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, new packages_files_map_1.PackagesFilesMap(modules, globals, "/" + modulesFolderPath + "/")]; // TODO
            }
        });
    });
}
...
function copyFiles(packagesFilesMap, outDir, modulesFolder, cwd) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    progress = createProgressBar(Object.keys(packagesFilesMap.modules).length, 'Copying files...');
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    ...
                                                    return [4 /*yield*/, copyFile(packagesFilesMap.modules[key].folder, file, outDirPath, packagesFilesMap)
                                    ...
                                    _i = 0, _a = packagesFilesMap.modules[key].files;
                                    _b.label = 1;
                                case 1:
                    ...
                    _a = [];
                    for (_b in packagesFilesMap.modules)
                        _a.push(_b);
                    _i = 0;
                    _c.label = 1;
                case 1:
